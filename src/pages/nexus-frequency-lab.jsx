...
export default function MeditationChamber() {
  ...
  // Autoplay 963 Hz when Synchrony category is opened
  useEffect(() => {
    if (currentCategory === 'synchrony') {
      const synchronyTrack = categories.synchrony.tracks[0];
      handlePlayTrack(synchronyTrack);
    }
  }, [currentCategory]);
